...
from PROYECTO_ADSO.firebase_config import initialize_firebase
from functools import wraps
import requests
import os

# Inicializamos la base de datos con firestore
...
# -- Logica para el inicio de sesionlogin_required_firebase

# Decorador de seguridad

def login_required_firebase(view_func):
    """
    Este decorador personalizado, va a proteger las vistas si el 
    usuario no ha iniciado sesion.
    Si no existe el UID, lo enviara a iniciar sesion.
    """
...
# Logica para solicitud de autenticacion
...
def iniciar_sesion(request):
    ...
    if request.method == 'POST':
        ...
        # Enpoint oficial de google para el login
...
def listar_tareas(request):
    """
    READ: Recuperar todas las tareas del usuario que esten en firebase
    """
...
def eliminar_tarea(request, tarea_id):
    """
    DELETE: Elimina un documento especifico por su ID
    """
    try:
